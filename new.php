...
<body>
	...
	<div class="modal fade" id="addStructureModal" tabindex="-1" role="dialog" aria-labelledby="Add another data structure" aria-hidden="true">
											...
											<div class="col-sm-10">
												<div class="input-group">
													<span class="input-group-addon"> 
														<input type="checkbox" id="addRegisterCheck" />
													</span> 
													<input type="text" id="addRegisterValue" class="form-control" disabled placeholder="uninitialized" />
												</div>
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-sm-10">
												...
												<div class="tab-content">
													<div class="tab-pane active" id="addListUninitialized">
														<div class="panel panel-default panel-topless">
															<div class="panel-body">
																The elements of the list are going to be uninitialized.
															</div>
														</div>
													</div>
													...
													<div class="tab-pane" id="addListCustomized">
														<div class="panel panel-default panel-topless">
															<div class="panel-body">
																The elements of the list are going to be initialized
																with the following values (semicolon separated): 
																<input type="text" class="form-control" id="addListValues" placeholder="12; 14; 42; ...">
															</div>
														</div>
													</div>
												</div>
						...
						<div class="panel panel-default">
							...
							<div id="data" class="panel-collapse collapse in">
								<div class="panel-body">
									...
									<button class="btn btn-primary btn-lg" id="btn-addDataStructure">
										+ data structure
									</button>
								</div>
							</div>
