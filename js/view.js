...
(function() {
  var Player, Stats, init, initRandomVariables, toggleBreakpoints, toggleComment;
  ...
  initRandomVariables = function(scope) {
    var initElement, initList, randomBool, randomInt;
    randomBool = function() {
    ...
    initElement = function(variable, numberGen) {
      var value;
      value = numberGen();
      $(variable).find('.value').text(value);
      return $(variable).data('value', value);
    };
    initList = function(variable, numberGen) {
      var values;
      values = [];
      $(variable).find('.value-container').each(function() {
        var value;
        value = numberGen();
        $(this).find('.value').text(value);
        return values.push(value);
      });
      return $(variable).data('value', values.join(','));
    };
    return scope.find('.variable.random').each(function() {
      switch ($(this).data('type')) {
        case 'i':
          return initElement(this, randomInt);
        case '[i':
          return initList(this, randomInt);
        case 'b':
          return initElement(this, randomBool);
        case '[b':
          return initList(this, randomBool);
      }
    });
  };
