...
(function() {
  var Player, Stats, init, toggleBreakpoints, toggleComment;
  ...
  Player = (function() {
    ...
    Player.prototype.step = function() {
      var curNode, error1, runtimeError, value;
      this.clearHighlight();
      ...
      if ((this.nextCandidate != null)) {
        ...
        if (this.scope > 0) {
          ...
          window.players[this.scope - 1].returnFunction(this.scope, value);
        }
        return false;
      }
    };
    ...
    Player.prototype.returnFunction = function(scope, value) {
