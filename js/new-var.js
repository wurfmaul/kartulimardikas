...
$(function () {
    ...
    $.keyStroke(38, function () {
        varForm.moveSelectionUp("select");
    });
    $.keyStroke(38, { modKeys: ['altKey'] }, function () {
        varForm.moveSelectionUp("move");
    });
    $.keyStroke(38, { modKeys: ['shiftKey'] }, function () {
        varForm.moveSelectionUp("extend");
    });
    $.keyStroke(40, function () {
        varForm.moveSelectionDown("select");
    });
    $.keyStroke(40, { modKeys: ['altKey'] }, function () {
        varForm.moveSelectionDown("move");
    });
    $.keyStroke(40, { modKeys: ['shiftKey'] }, function () {
        varForm.moveSelectionDown("extend");
    });
    $.keyStroke(46, function () {
        varForm.performActionOnSelection("remove");
    }); // del
    $.keyStroke(27, function () {
        varForm.performActionOnSelection("cancel");
    }); // esc
    $.keyStroke(13, function () {
        varForm.performActionOnSelection("check");
    }); // return
});